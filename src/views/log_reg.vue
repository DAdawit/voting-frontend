<template>
    <div class="mt-5">
        <v-tabs v-model="tab" show-arrows background-color="blue-grey darken-4" icons-and-text dark grow>
                        ...
                        <v-form ref="registerForm" v-model="valid" lazy-validation>
                            <v-row>
                                ...
                                <v-col class="d-flex ml-auto" cols="12" sm="3" xsm="12">
                                    <v-btn x-large block :disabled="!valid" color="success" @click="validate">Register
                                    </v-btn>
                                </v-col>
                            </v-row>
                        </v-form>
